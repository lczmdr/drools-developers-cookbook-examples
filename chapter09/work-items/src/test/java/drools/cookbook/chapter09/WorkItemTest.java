...
public class WorkItemTest {
    ...
    @Test
    public void simpleHumanTaskWorkItem() throws InterruptedException {

        KnowledgeBuilder kbuilder = KnowledgeBuilderFactory.newKnowledgeBuilder();
        kbuilder.add(new ClassPathResource("htworkitem.bpmn2"), ResourceType.BPMN2);
        ...
        ksession.getWorkItemManager().registerWorkItemHandler("email_notification", new EmailNotificationWorkItem());

        Map<String, Object> params = new HashMap<String, Object>();
        ArrayList<String> emails = new ArrayList<String>();
        emails.add("reviewer@foo.com");
        emails.add("translator@foo.com");
        params.put("emails", emails);

        ProcessInstance processInstance = ksession.startProcess("document-publication", params);
